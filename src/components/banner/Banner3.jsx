...
function Banner3() {
  ...
  return (
    <div className="banner-section3 overflow-hidden position-relative ml-230">
      <img
        src="/assets/images/slider/home03/image02.jpg"
        className="banner-bg31"
        alt="image"
      />
        ...
        <div className="row justify-content-center align-items-center g-4">
          <div className="col-xl-7 col-lg-8 col-md-10 text-lg-start text-center">
            <div className="banner3-content">
              <span>Es-tu prêt?</span>
              <h2>meilleurs &amp; incroyables offers voyages</h2>
              <p>Offrez-vous un voyage vers votre moi intérieur.</p>
              {/* <Link href="/">
                <a className="eg-btn btn--white btn--lg">Découvrir plus</a>
              </Link> */}
            </div>
          </div>
          {/* <div className="col-xl-5 col-lg-4 col-md-10">
            <div className="banner-form-box sibling-2">
              ...
              <form className="banner-form">
                ...
                <button className="eg-btn btn--primary2 btn--lg w-100">
                  Find Now
                </button>
              </form>
            </div>
