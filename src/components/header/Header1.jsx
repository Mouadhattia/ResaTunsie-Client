            ...
            <Link href="/">
              <a>
                <img
                  ...
                  width={130}
                  height={45}
                  src="/assets/images/icons/logocc.png"
                />
              </a>
            </Link>
          </div>
          <div className={showMobileMenu ? "main-nav show-menu " : "main-nav"}>
            ...
            <ul className="menu-list">
              {/* <li className="menu-item-has-children">
                <Link href="http://localhost:3000/">
                  <a href="/index-travel2">Accueil</a>
                </Link>
              </li> */}
              <li className="menu-item-has-children">
                <Link href="/">
                ...
                >
                  <li>
                    ...
                    <ul
                      className={
                        showsubMenu ? "sub-menu d-block" : "sub-menu d-none"
                      }
                    >
                      <li>
                        <Link href="#">
                ...
                <Link href="/tour-package2">
                  <a
                    className={
                      ...
                      currentRoute === "/tour-package-detailstravel"
                        ? "drop-down active"
                        : "drop-down disabled"
                    }
                  >
            ...
            <div className="phone-call sibling2 d-flex justify-content-start align-items-center flex-row d-lg-none d-block mt-5">
              ...
              <div className="number">
                ...
                <h5>
                  <a href="tel:0021627801945">27801945</a>
                </h5>
              </div>
            </div>
            <Link href="/tour-package2">
