  ...
  return (
    ...
    >
      <div className="tour-information">
        ...
        <p>
          Notre équipe passionnée est dédiée à vous fournir un service
          exceptionnel et à vous aider à planifier le voyage de vos rêves. Nous
          travaillons avec les meilleures compagnies aériennes, les meilleurs
          hôtels et les meilleurs prestataires de services pour vous offrir des
          options de voyage de qualité supérieure. Que vous cherchiez une
          escapade romantique, des vacances en famille ou un voyage
          d&apos;affaires, nous pouvons personnaliser votre itinéraire pour
