...
function Information({ price, duration, desc, Prices, included, notIncluded }) {
  return (
    <div
    ...
    >
      <div className="tour-information">
        ...
        <div className="tour-info-list-area">
          ...
          <ul className="info-list-1">
            <li>
              <span> Non inclus dans le prix</span>
              <ul className="info-sublist">
                {notIncluded?.map((e, key) => (
                  <li key={key}>
                    <i className="bx bx-x" />
                    {e}
                  </li>
        ...
        <p>
          « En optant pour des prestations de qualité, on gagne en crédibilité,
          en confiance des clients et on aboutit à la réalisation des bénéfices
          permettant à la viabilité et à la pérennité de l’agence », reconnaît
          le directeur de Resa tunsie qui accorde un bon point à l’agence de
          Nouvelair dans le sens où le transport aérien joue un rôle capital
          dans la réussite de ce volet de la « Omra ».
        </p>
        <div className="row details-img-group justify-content-center g-4">
          <div className="col-lg-4 col-md-4 col-sm-4 col-6">
            <img
              src="https://cdn2.webmanagercenter.com/di/wp-content/uploads/2013/06/omra-tunisie.jpg"
          ...
          <div className="col-lg-4 col-md-4 col-sm-4 col-6">
            <img
              style={{ width: "100%", height: "20rem" }}
              src="https://www.tunisie-tribune.com/wp-content/uploads/2019/12/demarrage-de-la-saison-de-la-omra-apres-des-mois-de-retard.jpg"
              className="img-fluid"
              alt="image"
            />
          </div>
          <div className="col-lg-4 col-md-4 col-sm-4 col-6">
            <img
              style={{ width: "100%", height: "20rem" }}
              src="https://image.resabooking.com/images/images_og/img_p_hotel_og_999.jpg"
              className="img-fluid"
              alt="image"
            />
          </div>
            ...
            <div className="accordion" id="accordionExample">
              <div className="accordion-item">
                <h2 className="accordion-header" id="headingOne">
                  ...
                  >
                    01. Who’s the most interesting person you’ve ever met on a
                    plane?
                  </button>
                </h2>
                <div
                ...
                >
                  <div className="accordion-body">
                    <p>
                      ...
                      sublime: from the UFO-like dragon&apos;s blood trees in
                      Yemen to a rainbow-colored hot spring in Yellowstone to a
                      bridge in Germany that looks like a leftover prop from
                      Lord of the Rings.
                    </p>
                  </div>
                </div>
              ...
              <div className="accordion-item">
                <h2 className="accordion-header" id="headingThree">
                  ...
                  >
                    03. Who’s the most interesting person you’ve ever met on a
                    plane?
                  </button>
                </h2>
                <div
