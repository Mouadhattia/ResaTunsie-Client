...
import { createTravel } from "../../actions/actions";

function BookingFormTravel({ id }) {
  ...
  const handleCreateOmra = (e) => {
    ...
    if (
      ...
      createTravel({ ...omra, travelId: Number(id) }).then(() => {
  ...
  return (
    <div className="booking-form-box">
      <h3>Réservez</h3>
      <p>
        Organisez votre voyage à l&apos;avance - réservez cette visite
        maintenant!
      </p>
