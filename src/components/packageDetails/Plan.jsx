  ...
  return (
    <div className="tab-pane fade" id="v-pills-plan" role="tabpanel" aria-labelledby="v-pills-plan-tab">
            <div className="tour-plan">
              ...
              <div className="tour-plan-single">
                <div className="plan-serial">
                  <span>01</span>
                </div>
                <div className="plan-content">
                  <h4 className="plan-title">Day 01 : Departure</h4>
              ...
              <div className="tour-plan-single">
                ...
                <div className="plan-content">
                  <h4 className="plan-title">Day 02 : Adventure Beggins</h4>
                  <p>Arrive Cairo airport, welcome greeting by our representative who will assist you and provide tra nsfers to your Hotel in Cairo. (the clients will inform us about their arrival time minimum 7 days before the</p>
                  <ul className="plan-list">
                    <li>Admire Big Ben, Buckingham Palace and St Paul’s Cathedral</li>
                    <li>Chance to spot prominent landmarks of the city</li>
              ...
              <div className="tour-plan-single">
                ...
                <div className="plan-content">
                  <h4 className="plan-title">Day 03 : Historical Tour</h4>
              ...
              <div className="tour-plan-single">
                ...
                <div className="plan-content">
                  <h4 className="plan-title">Day 04 : Rest &amp; Tour</h4>
              ...
              <div className="tour-plan-single">
                ...
                <div className="plan-content">
                  <h4 className="plan-title">Day 05 : Return</h4>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                </div>
              </div>
            </div>
